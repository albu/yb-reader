...
const MAGIC: &[u8; 8] = b"YBSNAP03";
pub const MAX_CACHED_FILES: usize = 15; // 3 pages x 5 books
...
pub fn load_snapshot_from(
    ...
    // Must match the requested page, dimensions, font size, and visual settings
...
pub fn save_snapshot_to(
    ...
    buf.extend_from_slice(&[0u8; 2]); // 2 bytes padding to align to 36 bytes
...
mod tests {
    ...
    fn test_garbage_collection_pruning() {
        ...
        // Must be pruned down to MAX_CACHED_FILES (15)
